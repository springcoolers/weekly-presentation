...
"""
# file_path = "/home/moonstar/python/NLP/OCR/data/cnn_stries_tokenized/0a0a4c90d59df9e36ffec4ba306b4f20f3ba4acb.story" 
# file_path = "/home/moonstar/python/NLP/OCR/data/cnn" 
file_path = "/home/moonstar/python/NLP/OCR/data/cnn_news/total.story"
...
data1 = data_sents
file_path1 = "data/data_sents_news.pickle"  # Specify the file path and name
...
for i in range(len(texts)):
    ...
    # Save the image
    image.save("data/original_text_news/text_image" + str(i) + ".png")